...
#include "DMXDetectorRoom.ihh"
  ...
  G4LogicalVolume*   SiPM_PCB_Inn1_log;
  G4VPhysicalVolume* SiPM_PCB_Inn1_phys;
  G4LogicalVolume*   SiPM_PCB_Out1_log ;
  G4VPhysicalVolume* SiPM_PCB_Out1_phys;  
  G4LogicalVolume*   SiPM_PCB_Inn2_log;
  G4VPhysicalVolume* SiPM_PCB_Inn2_phys;
  G4LogicalVolume*   SiPM_PCB_Out2_log ;
  G4VPhysicalVolume* SiPM_PCB_Out2_phys; 
  G4LogicalVolume*   SiPM_PCB_Inn3_log;
  G4VPhysicalVolume* SiPM_PCB_Inn3_phys;
  G4LogicalVolume*   SiPM_PCB_Out3_log ;
  G4VPhysicalVolume* SiPM_PCB_Out3_phys; 
  G4LogicalVolume*   SiPM_PCB_Inn4_log;
  G4VPhysicalVolume* SiPM_PCB_Inn4_phys;
  G4LogicalVolume*   SiPM_PCB_Out4_log ;
  G4VPhysicalVolume* SiPM_PCB_Out4_phys; 
  G4LogicalVolume*   SiPM_PCB_Inn5_log;
  G4VPhysicalVolume* SiPM_PCB_Inn5_phys;
  G4LogicalVolume*   SiPM_PCB_Out5_log ;
  G4VPhysicalVolume* SiPM_PCB_Out5_phys; 
  ...
  G4LogicalVolume*   RTD_mother_log;
  G4VPhysicalVolume* RTD_mother_phys;
  G4LogicalVolume*   RTD_block_log;
  G4VPhysicalVolume* RTD_block_phys;
  //G4LogicalVolume*   RTD_base_log;
  //G4VPhysicalVolume* RTD_base_phys;
  //G4LogicalVolume*   RTD_wire_clamp_log;
  //G4VPhysicalVolume* RTD_wire_clamp_phys;
  //G4LogicalVolume*   RTD_connector_1_4_log;
  //G4VPhysicalVolume* RTD_connector_1_4_phys;
  //G4LogicalVolume*   RTD_connector_feedthru_log;
  //G4VPhysicalVolume* RTD_connector_feedthru_phys;
  
  G4LogicalVolume*   RTD_Cable_Kapton_log;
  G4VPhysicalVolume* RTD_Cable_Kapton_phys;
  G4LogicalVolume*   RTD_Cable_Cu_log;
  G4VPhysicalVolume* RTD_Cable_Cu_phys;
  G4LogicalVolume*   RTD_Cable_Cu_1_log;
  G4VPhysicalVolume* RTD_Cable_Cu_1_phys;
